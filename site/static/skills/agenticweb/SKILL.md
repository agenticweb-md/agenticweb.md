...
For agents with shell access, the official npm packages provide programmatic validation and generation:
...
npx @agenticweb-md/validator ./agenticweb.md --json
```
...
npx @agenticweb-md/generator --minimal

# Specify output path
npx @agenticweb-md/generator -o ./my-project/agenticweb.md
```

These tools are the **recommended method** for validation and generation when shell access is available.
